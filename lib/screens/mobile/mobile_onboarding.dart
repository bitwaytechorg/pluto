...
class Mobile_onboarding extends StatefulWidget {
  @override
  Mobile_onboardingState createState() => Mobile_onboardingState();
}

class Mobile_onboardingState extends State<Mobile_onboarding> {
  double xOffset = 0;
  double yOffset = 0;
  ...
  buildContent() {
    return Container(child: Text("On Boarding Screen."),);
  }
}
